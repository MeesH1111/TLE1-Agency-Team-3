<x-base-layout>
    <x-slot:title>
        Van Doorzetter naar Inspiratie
    </x-slot:title>
    ...
    <div class="container">
        <section class="story">
            ...
            <a href="{{ route('categories.index') }}" class="btn" id="story-button-nico" aria-label="Knop om naar de categorieën van vacatures te gaan">Vacatures</a>
        </section>
    </div>
